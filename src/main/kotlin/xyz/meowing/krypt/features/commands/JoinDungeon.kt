...
@Command
object JoinDungeonCommand : Commodore("jd") {
    ...
    init {
        runs { floor: GreedyString ->
            ...
            val masterMode = floor.string.contains("m", ignoreCase = true)
            val floorString = floor.string.replace("e", "0").replace("""[^0-9]""".toRegex(), "")
